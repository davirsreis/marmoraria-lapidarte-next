...
export default function NobileStone() {
  ...
  return (
    <ProdutoSeparado
      nome="NobileStone"
      texto="Uma expressão de luxo e sofisticação, eleva o ambiente com sua beleza distinta e exclusiva. Ideal para aqueles que buscam um toque de opulência em seus projetos,  é a escolha perfeita para criar espaços verdadeiramente sofisticados."
      imagem="bg-img_bg_fundo_nobilestone"
