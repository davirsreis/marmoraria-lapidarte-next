      ...
      {!dados ? (
        ...
        <>
          <section className="flex flex-col w-full bg-third-neutral">
            ...
            <ul className={`flex text-base smLess:text-lg sm:text-2xl py-5 smLess:py-10 sm:py-20 gap-2 smLess:gap-4 sm:gap-6 text-center justify-center text-second-blue font-semibold tracking-[0.05em] smLess:tracking-[0.1em] sm:tracking-[0.2em] ${fontePrincipal}`}>
