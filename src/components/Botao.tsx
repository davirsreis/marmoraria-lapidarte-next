...
export function Botao(props: BotaoProps) {
  ...
  const colorVariants = {
    azul: ['bg-primary-blue hover:bg-second-blue', 'text-base sm:text-[24px] text-primary-neutral'],
  ...
  return (
    <button onClick={props.onClick} className={`flex justify-center text- items-center p-2 rounded-[10px] ${props.customClass} ${colorVariants[props.cor][0]}`}>
