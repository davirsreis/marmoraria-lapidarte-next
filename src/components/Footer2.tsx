...
export function Footer2() {
  ...
  return (
    <footer className="w-full h-[120px] bg-white flex flex-col justify-evenly text-center p-4">
      <div className="flex w-full justify-between items-center px-20">
        <div className="w-[300px] flex flex-col text-center">
          <span>E-mail: marmorarialapidarte@gmail.com</span>
          <span>Número: (61) 99999-9999</span>
        </div>
        <Image
          src={'https://firebasestorage.googleapis.com/v0/b/marmorarialapidarteofc.appspot.com/o/imagensAplicacao%2FlogoLapidarte.png?alt=media&token=cb3301a9-112b-4d6c-9792-c42f0ef8e73f'}
          alt="Logo Lapidarte"
          width={96} height={96} />
        <div className="w-[300px] flex flex-col">
          <div className="flex gap-2">
            ...
            <span>@lapidarte.marmoraria</span>
          </div>
          <div className="flex gap-2">
            <div className="h-7 w-7">
      ...
      <div className="w-full flex items-center justify-center">
        <span className="text-sm">Parte das imagens fornecidas por <a className="text-blue-500" href="https://br.freepik.com" target="_blank">Freepik</a></span>
      </div>
    </footer>
  );
}