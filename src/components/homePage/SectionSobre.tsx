...
export function SectionSobre() {
  ...
  return (
    <section className="w-full flex flex-col bg-third-neutral py-[32px] smLess:py-[48px] sm:py-[64px]">
      <div className="flex flex-col items-center pb-8 smLess:pb-12 sm:pb-16">
        <Image
          src={LogoLapidarte}
          alt="Logo Lapidarte"
