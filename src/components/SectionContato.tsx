...
export function SectionContato() {
  return (
    <section className="w-full bg-img_bg_fundo_contato bg-no-repeat bg-center bg-cover flex justify-center items-center py-[120px]">
      <div className="flex flex-col lgPlus:flex-row justify-evenly gap-20">
        ...
        <div className="w-[564px] h-[300px] flex flex-col items-center justify-center gap-5">
          <span className="text-2xl text-white">Entre em contato!</span>
          <div className="w-[500px] flex justify-center items-center p-4 gap-4">
            ...
            <p className="text-2xl text-white font-semibold text-center">(61) 99999-9999</p>
          </div>
          ...
          <div className="w-[500px] flex justify-center items-center p-4 gap-4">
            ...
            <p className="text-2xl text-white font-semibold text-center">marmorarialapidarte@gmail.com</p>
          </div>
        </div>
      </div>
    </section>
